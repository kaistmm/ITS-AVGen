#!/bin/bash
# EvoSearch inference script
# Usage: bash scripts/inference_evo.sh [GPU_ID] [NSHARD] [SHARD_ID]
# Examples:
...
cfg_file="configs/javisdit-v0-1/inference/sample_240p4s_evo.py"
save_dir="samples/generated_evosearch_$(date +%Y%m%d_%H%M%S)"
...
echo "Running EvoSearch inference"
